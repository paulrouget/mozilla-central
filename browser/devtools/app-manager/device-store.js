...
DeviceStore.prototype = {
  ...
  _listTabs: function() {
    this._connection.client.listTabs((resp) => {
      this._deviceFront = new DeviceFront(this._connection.client, resp);
  ...
  _feedStore: function(deviceFront, webAppsActor) {
    ...
    .then(() => this._getDevicePermissionsTable())
    .then(() => this._listenToApps())
    .then(() => this._getAllApps())
    .then(() => this._getRunningApps())
    .then(() => this._getAppsIcons())
